...
//种子源配置参数信息
int SeedSource_Parameter[8] = {0};
//驱动源配置参数
int PowerSupply_Parameter[20] = {0};

vector<vector<int>> g_seedsourceA(3);
vector<vector<int>> g_seedsourceB(3);
vector<vector<int>> g_powersupplyA(9);
vector<vector<int>> g_powersupplyB(9);
vector<vector<int>> g_soc(10);
