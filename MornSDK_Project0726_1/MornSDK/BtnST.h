...
public:
	//YWJ
	DWORD SetBtnNormal(BOOL bNormal = TRUE);
	DWORD SetBMPOverlaid(BOOL bOver = TRUE);
	...
	DWORD SetBitmaps(int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut = NULL, COLORREF crTransColorOut = 0, int nBitmapPressed=NULL, COLORREF crTransColorPressed=0);
	DWORD SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0, HBITMAP hBitmapPressed = NULL, COLORREF crTransColorPressed = 0);
...
protected:
	...
	BOOL		m_bIsNormal;		// Is a normal button? //YWJ
	BOOL		m_bBMPOverlay;		// Is overlaid with a bitmap?  //YWJ
...
#pragma pack()
	...
	STRUCT_BITMAPS	m_csBitmaps[3];	//YWJ 2->3
